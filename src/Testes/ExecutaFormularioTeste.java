 ...
 */
public class ExecutaFormularioTeste {    

    public void processaDados(){
        JOptionPane.showMessageDialog(null, "MENSAGEM DE TESTES");
        
        ViewManutencaoCor cor = new ViewManutencaoCor();
        cor.setVisible(true);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ExecutaFormularioTeste executa = new ExecutaFormularioTeste();
                executa.processaDados();
            }
        });
    }
}