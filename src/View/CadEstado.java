...
//    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 350, 165));
        ...
        btnCancelar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Faturamento/Knob Add.png"))); // NOI18N
        btnCancelar1.setText("Incluir");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 142, 210));

        btnGravar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Faturamento/Knob Valid Green.png"))); // NOI18N
        btnGravar.setMnemonic('C');
        ...
        getContentPane().add(btnGravar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 120, 40));
        ...
        getContentPane().add(btnSair, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 120, 40));

        setBounds(0, 0, 549, 276);
