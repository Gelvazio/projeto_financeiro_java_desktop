 ...
 * @author Gelvazio
 */
public class ConsultaVendedores extends MetodosGlobais {

    String mensagem;
    String mensagem_dois;
    String SQLConsultaFornecedores;
    ...
    private void PegaValorCamposComboboxCampo_E_Valor(String SQLValorCamposComboboxCampo_E_Valor) {
        ...
        SQLValorCamposComboboxCampo_E_Valor = "select * from PESSOA where pessoa.fg_VENDEDOR=1 and " + auxCampo + " " + auxValor;
    ...
    private ArrayList SQLConsultagetTodos_Completo() {
        ...
        try {
            ...
            //Nessa Parte é passado po parametro os Dados da Variavel "SQLConsultaFornecedores" que contem o sql da pesquisa.
            rs = stmt.executeQuery(SQLConsultaFornecedores);
            while (rs.next()) {
    ...
    private void ListaTodosFornecedores() {
        ...
        ArrayList<Pessoa> pessoas = pessoadb.getTodosVendedores();
    ...
    public ConsultaVendedores(JTextField campoCodigo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consulta Vendedores");
