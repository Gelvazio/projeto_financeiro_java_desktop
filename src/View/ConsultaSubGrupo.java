 ...
 * @author Gelvazio
 */
public class ConsultaSubGrupo extends MetodosGlobais {
    ...
    public ConsultaSubGrupo(JTextField campoCodigo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consulta SubGrupo de Produtos");
