 ...
 * @author Gelvazio
 */
public class ConsultaFornecedores extends MetodosGlobais {
    ...
    private void ListaTodosFornecedores() {
        ...
        ArrayList<Pessoa> pessoas = pessoadb.getTodosFornecedores();
    ...
    private void ListaTodosVendedores() {
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.addColumn("Codigo");
        modelo.addColumn("Nome");
        modelo.addColumn("CPF");
    ...
    public ConsultaFornecedores(JTextField campoCodigo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consulta Fornecedores");
