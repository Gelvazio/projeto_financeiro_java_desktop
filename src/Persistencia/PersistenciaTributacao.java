 ...
 */
public class PersistenciaTributacao {
    
    public static int REGIME_TRIBUTACAO_PESSOA_FISICA    = 0;
    public static int REGIME_TRIBUTACAO_NORMAL           = 1;
    public static int REGIME_TRIBUTACAO_SIMPLES_NACIONAL = 2;
    
    public static int TIPO_CONSUMO_CONSUMO = 0;
    public static int TIPO_CONSUMO_REVENDA = 1;
}
