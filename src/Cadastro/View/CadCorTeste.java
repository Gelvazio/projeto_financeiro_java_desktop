 ...
 */
public class CadCorTeste extends JFrame {
    ...
    public void iniciaTela() {
      ...
      private void chamaFormularioConsultaCorPadrao(){
        ConsultaCorPadrao formulario = new ConsultaCorPadrao();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 206, 24));
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        chamaFormularioConsultaCorPadrao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadCorTeste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CadCorTeste().setVisible(true);
            }
        });
    }
