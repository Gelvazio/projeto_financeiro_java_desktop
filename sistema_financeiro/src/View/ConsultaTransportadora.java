 ...
 * @author Gelvazio
 */
public class ConsultaTransportadora extends MetodosGlobais {
    ...
    private void PegaValorCamposComboboxCampo_E_Valor(String SQLValorCamposComboboxCampo_E_Valor) {
        ...
        SQLValorCamposComboboxCampo_E_Valor = "select * from PESSOA WHERE PESSOA.FG_TRANSPORTADOR=1 AND " + auxCampo + " " + auxValor;
    ...
    public ConsultaTransportadora(JTextField campoCodigo) {
        initComponents();
        ListaTodasTransportadoras();
        centro();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consulta Transportadora");
