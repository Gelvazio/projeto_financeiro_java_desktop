...
public class VendaClasse {
    ...
    public VendaClasse(int cd_filial, int cd_movimento, int cd_usuario, int cd_vende, int cd_pagto, int cd_pessoa, double vl_tot_cus_doc, double vl_tot_pro_doc, int fg_situacao, int cd_tipo_nota) {
