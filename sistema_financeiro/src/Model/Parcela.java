...
public class Parcela {
    ...
    public Parcela(int cd_filial, long cd_movimento, long cd_documento, int nr_parcela, int fg_situacao, double vl_parcela, double vl_juros, int cd_condicao_pagamento, int sequencia_parcela, double vl_acrescimo, double vl_desconto, Date dt_vencto_par, int cd_tipo_cobranca, int cd_usuario, Date dt_alt, Time hr_alt, Date dt_cad, Time hr_cad, Date dt_pag_par, double vl_pago, int cd_pessoa) {
